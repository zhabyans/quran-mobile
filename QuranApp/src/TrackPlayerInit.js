...
import TrackPlayer, { TrackPlayerEvents, STATE_STOPPED } from 'react-native-track-player';
...
const TrackPlayerInit = (props) => {
    ...
    const onButtonPlayPause = () => {
        if (isPlaying) {
            ...
            console.log('skrg pause')
            setIsPlaying(false);
        } else {
            TrackPlayer.play();
            setText('Pause Audio')
            console.log('skrg jalan')
            setIsPlaying(true);
        }
    };
